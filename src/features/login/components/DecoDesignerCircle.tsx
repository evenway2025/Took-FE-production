...
export const DecoDesignerCircle = (props: HTMLAttributes<HTMLDivElement>) => {
  const { className, ...restProps } = props;

  return (
    <div className={cn(className)} {...restProps}>
      <div className="bg-[rgba(255,255,255, 0.2)] absolute top-0 h-[144px] w-[144px] rounded-full backdrop-blur-[16px]" />
      <svg width="144" height="144" viewBox="0 0 220 221" fill="none" xmlns="http://www.w3.org/2000/svg">
